            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('admin.packages.index') }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-gray-700 transition duration-300">
                            Back to Packages
                        </a>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.packages.update', $package) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="max_travelers" name="max_travelers" min="1" value="{{ old('max_travelers', $package->max_travelers) }}" required 
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                        placeholder="20">
                                    @error('max_travelers')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mb-6">
                                ...
                                <div id="highlights-container" class="space-y-2">
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <button type="button" onclick="removeField(this)" class="bg-red-500 text-white px-3 py-2 rounded-lg hover:bg-red-600">
                                            Remove
                                        </button>
                                    </div>
                                    @endforeach
                                ...
                                <button type="button" onclick="addField('highlights-container', 'highlights[]')" class="mt-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">
                                    Add Highlight
                                </button>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <button type="button" onclick="addField('itinerary-container', 'itinerary[]')" class="mt-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">
                                    Add Itinerary Item
                                </button>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <button type="button" onclick="addField('inclusions-container', 'inclusions[]')" class="mt-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">
                                    Add Inclusion
                                </button>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <button type="button" onclick="addField('exclusions-container', 'exclusions[]')" class="mt-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">
                                    Add Exclusion
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end space-x-4">
                            <a href="{{ route('admin.packages.index') }}" class="bg-gray-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-700 transition duration-300">
                                Cancel
                            </a>
