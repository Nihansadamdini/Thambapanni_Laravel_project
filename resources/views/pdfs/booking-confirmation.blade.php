...
<body>
    <div class="header">
        ...
        <div class="booking-number">{{ $booking_number }}</div>
    </div>
        ...
        <div class="package-details">
            <div class="info-grid">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">{{ $package->duration }}</div>
                </div>
                <div class="info-row">
    ...
    <div class="section">
        ...
        <div class="info-grid">
            <div class="info-row">
                ...
                <div class="info-value">{{ $booking->number_of_travelers }}</div>
            </div>
            <div class="info-row">
                <div class="info-label">Special Requirements:</div>
                <div class="info-value">{{ $booking->special_requirements ?? 'None' }}</div>
            </div>
            <div class="info-row">
                <div class="info-label">Additional Notes:</div>
                <div class="info-value">{{ $booking->additional_notes ?? 'None' }}</div>
            </div>
        </div>
    </div>
        ...
        <div class="price-summary">
            <div class="info-grid">
                <div class="info-row">
                    ...
                    <div class="info-value">${{ number_format($package->price, 2) }}</div>
                </div>
                <div class="info-row">
                    <div class="info-label">Number of Travelers:</div>
                    <div class="info-value">{{ $booking->number_of_travelers }}</div>
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">${{ number_format($package->price * $booking->number_of_travelers, 2) }}</div>
                </div>
    ...
    <div class="footer">
        ...
        <p>This confirmation was generated on {{ $generated_at }}</p>
