                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="space-y-2">
                                    <a href="{{ route('customer.packages.show', $package) }}" 
                                        class="block w-full bg-blue-600 text-white text-center py-2 px-4 rounded hover:bg-blue-700 transition duration-300 text-sm">
                                        View Details
                                    </a>
                                    <a href="{{ route('customer.packages.book', $package) }}" 
                                        class="block w-full bg-green-600 text-white text-center py-2 px-4 rounded hover:bg-green-700 transition duration-300 text-sm">
                                        Book Now
                                    </a>
                                </div>
                            </div>
            ...
            @else
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-12 text-center">
                        ...
                        <a href="{{ route('customer.packages') }}" 
                            class="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300 inline-block">
                            View All Packages
                        </a>
                    </div>
                </div>
