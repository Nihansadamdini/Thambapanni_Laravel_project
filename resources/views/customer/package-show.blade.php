                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="space-y-3">
                                        <a href="{{ route('customer.packages.book', $package) }}" 
                                            class="w-full bg-green-600 text-white text-center py-3 px-4 rounded-lg font-semibold hover:bg-green-700 transition duration-300 block">
                                            Book Now
                                        </a>
                            ...
                            @else
                                <div class="text-center py-8">
                                    ...
                                    <a href="{{ route('customer.packages') }}" 
                                        class="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700 transition duration-300 inline-block">
