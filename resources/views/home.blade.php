<x-app-layout>
    <!-- Hero Section -->
    <div class="relative min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-green-600 overflow-hidden">
        <!-- Background Pattern -->
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
                    <a href="{{ route('packages') }}" class="group bg-white text-blue-600 px-6 sm:px-8 lg:px-10 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg shadow-2xl hover:shadow-blue-500/25 hover:scale-105 transition-all duration-300 inline-flex items-center w-full sm:w-auto justify-center">
                    ...
                    <a href="{{ route('contact') }}" class="group border-2 border-white text-white px-6 sm:px-8 lg:px-10 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg hover:bg-white hover:text-blue-600 hover:scale-105 transition-all duration-300 inline-flex items-center backdrop-blur-sm w-full sm:w-auto justify-center">
                        <svg class="w-5 sm:w-6 h-5 sm:h-6 mr-2 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
