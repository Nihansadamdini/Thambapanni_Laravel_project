...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/packages/{package}/edit', [AdminController::class, 'packagesEdit'])->name('packages.edit');
...
Route::middleware(['auth', 'role:customer'])->prefix('customer')->name('customer.')->group(function () {
    ...
    Route::get('/packages/{package}/book', [CustomerController::class, 'bookPackage'])->name('packages.book');
    Route::post('/packages/{package}/book', [CustomerController::class, 'storeBooking'])->name('packages.book.store');
    Route::get('/bookings/{booking}/payment', [CustomerController::class, 'payment'])->name('payment');
    Route::post('/bookings/{booking}/payment', [CustomerController::class, 'processPayment'])->name('payment.process');
